 ...
 */
export declare function create({ shape, chunks, dtype, compressor, fillValue, order, store, overwrite, path, chunkStore, filters, cacheMetadata, cacheAttrs, readOnly }: CreateArrayOptions): Promise<ZarrArray>;
/**
 * Create an empty array.
 */
export declare function empty(shape: number | number[], opts?: CreateArrayOptionsWithoutShape): Promise<ZarrArray>;
/**
 * Create an array, with zero being used as the default value for
 * uninitialized portions of the array.
 */
export declare function zeros(shape: number | number[], opts?: CreateArrayOptionsWithoutShape): Promise<ZarrArray>;
/**
 * Create an array, with one being used as the default value for
 * uninitialized portions of the array.
 */
export declare function ones(shape: number | number[], opts?: CreateArrayOptionsWithoutShape): Promise<ZarrArray>;
/**
 * Create an array, with `fill_value` being used as the default value for
 * uninitialized portions of the array
 */
export declare function full(shape: number | number[], fillValue: FillType, opts?: CreateArrayOptionsWithoutShape): Promise<ZarrArray>;
export declare function array(data: Buffer | ArrayBuffer | NestedArray<TypedArray>, opts?: CreateArrayOptionsWithoutShape): Promise<ZarrArray>;
export declare function openArray({ shape, mode, chunks, dtype, compressor, fillValue, order, store, overwrite, path, chunkStore, filters, cacheMetadata, cacheAttrs }?: {
    shape?: number | number[];
