 ...
 */
export declare function containsGroup<T>(store: Store, path?: string | null): Promise<boolean>;
 ...
 */
export declare function initArray(store: Store, shape: number | number[], chunks: ChunksArgument, dtype: DtypeString, path?: string | null, compressor?: null | CompressorConfig, fillValue?: FillType, order?: Order, overwrite?: boolean, chunkStore?: null | Store, filters?: null | Filter[]): Promise<void>;
