...
export declare class ZarrArray {
    ...
    getRawChunk(chunkCoords: number[]): Promise<RawArray>;
    private chunkKey;
    ...
    set(selection: number | Slice | ":" | "..." | import("./types").DimensionArraySelection[] | number[] | null | undefined, value: any, opts?: SetOptions): Promise<void>;
