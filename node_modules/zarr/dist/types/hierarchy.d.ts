...
import { CreateArrayOptionsWithoutShape } from './creation';
...
export declare class Group implements AsyncMutableMapping<Group | ZarrArray> {
     ...
     * Creates an array
     */
    array(name: string, data: Buffer | ArrayBuffer | NestedArray<TypedArray>, opts?: CreateArrayOptionsWithoutShape, overwrite?: boolean): Promise<ZarrArray>;
    empty(name: string, shape: number | number[], opts?: CreateArrayOptionsWithoutShape): Promise<ZarrArray>;
    zeros(name: string, shape: number | number[], opts?: CreateArrayOptionsWithoutShape): Promise<ZarrArray>;
    ones(name: string, shape: number | number[], opts?: CreateArrayOptionsWithoutShape): Promise<ZarrArray>;
    full(name: string, shape: number | number[], fillValue: number | null, opts?: CreateArrayOptionsWithoutShape): Promise<ZarrArray>;
    createDataset(name: string, shape?: number | number[], data?: Buffer | ArrayBuffer | NestedArray<TypedArray>, opts?: CreateArrayOptionsWithoutShape): Promise<ZarrArray>;
