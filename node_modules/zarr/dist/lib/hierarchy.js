 ...
 */
export function group(store, path = null, chunkStore, overwrite = false, cacheAttrs = true) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 *
 */
export function openGroup(store, path = null, mode = "a", chunkStore, cacheAttrs = true) {
    return __awaiter(this, void 0, void 0, function* () {
        store = normalizeStoreArgument(store);
