...
function createTexture(layer, image) {
  ...
  var texture = new _core.Texture2D(gl, _objectSpread(_objectSpread({}, image), {}, {
    parameters: _objectSpread(_objectSpread({}, DEFAULT_TEXTURE_PARAMETERS), layer.props.textureParameters)
  }));
