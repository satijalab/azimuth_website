...
},{"base64-js":"yh9p","ieee754":"JgNJ","isarray":"REa7","buffer":"dskh"}],"VCcH":[function(require,module,exports) {
...
},{"buffer":"dskh","util":"rDCW"}],"pBGv":[function(require,module,exports) {
...
},{"../../../errors":"Yj9o"}],"Bm0n":[function(require,module,exports) {
...
},{"util-deprecate":"yM1o","./internal/streams/stream":"ExO1","buffer":"dskh","./internal/streams/destroy":"GRUB","./internal/streams/state":"TWVJ","../errors":"Yj9o","inherits":"Bm0n","./_stream_duplex":"Hba0","process":"pBGv"}],"Hba0":[function(require,module,exports) {
var process = require("process");
...
},{"./_stream_readable":"DHrQ","./_stream_writable":"WSyY","inherits":"Bm0n","process":"pBGv"}],"Wugr":[function(require,module,exports) {
...
},{"buffer":"dskh"}],"z0rv":[function(require,module,exports) {
...
},{"./lib/_stream_readable.js":"DHrQ","./lib/_stream_writable.js":"WSyY","./lib/_stream_duplex.js":"Hba0","./lib/_stream_transform.js":"tlBz","./lib/_stream_passthrough.js":"nwyA","./lib/internal/streams/end-of-stream.js":"mrEY","./lib/internal/streams/pipeline.js":"AJFC"}],"vexR":[function(require,module,exports) {
...
},{"./support/isBuffer":"vexR","inherits":"tcrG","process":"pBGv"}],"m2P9":[function(require,module,exports) {
var process = require("process");
...
},{"readable-stream":"tzeh","util":"gfUn","process":"pBGv"}],"JO74":[function(require,module,exports) {
function t(e,r){"use strict";var n=(r=r||{}).pos||0,i="<",a="<".charCodeAt(0),o=">",f=">".charCodeAt(0),s="-".charCodeAt(0),c="/".charCodeAt(0),u="!".charCodeAt(0),l="'".charCodeAt(0),d='"'.charCodeAt(0);function h(){for(var t=[];e[n];)if(e.charCodeAt(n)==a){if(e.charCodeAt(n+1)===c)return(n=e.indexOf(o,n))+1&&(n+=1),t;if(e.charCodeAt(n+1)===u){if(e.charCodeAt(n+2)==s){for(;-1!==n&&(e.charCodeAt(n)!==f||e.charCodeAt(n-1)!=s||e.charCodeAt(n-2)!=s||-1==n);)n=e.indexOf(o,n+1);-1===n&&(n=e.length)}else for(n+=2;e.charCodeAt(n)!==f&&e[n];)n++;n++;continue}var r=C();t.push(r)}else{var i=p();i.trim().length>0&&t.push(i),n++}return t}function p(){var t=n;return-2===(n=e.indexOf(i,n)-1)&&(n=e.length),e.slice(t,n+1)}var v="\n\t>/= ";function m(){for(var t=n;-1===v.indexOf(e[n])&&e[n];)n++;return e.slice(t,n)}var g=r.noChildNodes||["img","br","input","meta","link"];function C(){n++;const t=m(),r={};let i=[];for(;e.charCodeAt(n)!==f&&e[n];){var a=e.charCodeAt(n);if(a>64&&a<91||a>96&&a<123){for(var o=m(),s=e.charCodeAt(n);s&&s!==l&&s!==d&&!(s>64&&s<91||s>96&&s<123)&&s!==f;)n++,s=e.charCodeAt(n);if(s===l||s===d){var u=A();if(-1===n)return{tagName:t,attributes:r,children:i}}else u=null,n--;r[o]=u}n++}if(e.charCodeAt(n-1)!==c)if("script"==t){var p=n+1;n=e.indexOf("<\/script>",n),i=[e.slice(p,n-1)],n+=9}else if("style"==t){p=n+1;n=e.indexOf("</style>",n),i=[e.slice(p,n-1)],n+=8}else-1==g.indexOf(t)&&(n++,i=h());else n++;return{tagName:t,attributes:r,children:i}}function A(){var t=e[n],r=++n;return n=e.indexOf(t,r),e.slice(r,n)}var y,b=null;if(void 0!==r.attrValue){r.attrName=r.attrName||"id";for(b=[];-1!==(y=void 0,y=new RegExp("\\s"+r.attrName+"\\s*=['\"]"+r.attrValue+"['\"]").exec(e),n=y?y.index:-1);)-1!==(n=e.lastIndexOf("<",n))&&b.push(C()),e=e.substr(n),n=0}else b=r.parseNode?C():h();return r.filter&&(b=t.filter(b,r.filter)),r.setPos&&(b.pos=n),b}t.simplify=function(e){var r={};if(!e.length)return"";if(1===e.length&&"string"==typeof e[0])return e[0];for(var n in e.forEach(function(e){if("object"==typeof e){r[e.tagName]||(r[e.tagName]=[]);var n=t.simplify(e.children||[]);r[e.tagName].push(n),e.attributes&&(n._attributes=e.attributes)}}),r)1==r[n].length&&(r[n]=r[n][0]);return r},t.filter=function(e,r){var n=[];return e.forEach(function(e){if("object"==typeof e&&r(e)&&n.push(e),e.children){var i=t.filter(e.children,r);n=n.concat(i)}}),n},t.stringify=function(t){var e="";function r(t){if(t)for(var r=0;r<t.length;r++)"string"==typeof t[r]?e+=t[r].trim():n(t[r])}function n(t){for(var n in e+="<"+t.tagName,t.attributes)null===t.attributes[n]?e+=" "+n:-1===t.attributes[n].indexOf('"')?e+=" "+n+'="'+t.attributes[n].trim()+'"':e+=" "+n+"='"+t.attributes[n].trim()+"'";e+=">",r(t.children),e+="</"+t.tagName+">"}return r(t),e},t.toContentString=function(e){if(Array.isArray(e)){var r="";return e.forEach(function(e){r=(r+=" "+t.toContentString(e)).trim()}),r}return"object"==typeof e?t.toContentString(e.children):" "+e},t.getElementById=function(e,r,n){var i=t(e,{attrValue:r});return n?t.simplify(i):i[0]},t.getElementsByClassName=function(e,r,n){const i=t(e,{attrName:"class",attrValue:"[a-zA-Z0-9-s ]*"+r+"[a-zA-Z0-9-s ]*"});return n?t.simplify(i):i},t.parseStream=function(e,r){if("string"==typeof r&&(r=r.length+2),"string"==typeof e){var n=require("fs");e=n.createReadStream(e,{start:r}),r=0}var i=r,a="";return e.on("data",function(r){a+=r;for(var n=0;;){if(!(i=a.indexOf("<",i)+1))return void(i=n);if("/"!==a[i+1]){var o=t(a,{pos:i-1,parseNode:!0,setPos:!0});if((i=o.pos)>a.length-1||i<n)return a=a.slice(n),i=0,void(n=0);e.emit("xml",o),n=i}else i+=1,n=pos}}),e.on("end",function(){console.log("end")}),e},t.transformStream=function(e){const r=require("through2");"string"==typeof e&&(e=e.length+2);var n=e||0,i="";return r({readableObjectMode:!0},function(e,r,a){i+=e;for(var o=0;;){if(!(n=i.indexOf("<",n)+1))return n=o,a();if("/"!==i[n+1]){var f=t(i,{pos:n-1,parseNode:!0,setPos:!0});if((n=f.pos)>i.length-1||n<o)return i=i.slice(o),n=0,o=0,a();this.push(f),o=n}else n+=1,o=pos}a()})},"object"==typeof module&&(module.exports=t,t.xml=t);
},{"fs":"rDCW","through2":"m2P9"}],"j27V":[function(require,module,exports) {
...
},{"@babel/runtime/helpers/inherits":"d4H2","@babel/runtime/helpers/possibleConstructorReturn":"pxk2","@babel/runtime/helpers/getPrototypeOf":"UJE0","@babel/runtime/helpers/classCallCheck":"fcMS","@babel/runtime/helpers/createClass":"P8NW","@babel/runtime/helpers/typeof":"b9XL","./basedecoder":"FJDe"}],"tbG5":[function(require,module,exports) {
...
},{"../utils/common":"tbG5","./adler32":"uxo6","./crc32":"X4kj","./inffast":"LP5M","./inftrees":"uNlq"}],"Q3ZD":[function(require,module,exports) {
...
},{"./common":"tbG5"}],"xUUw":[function(require,module,exports) {
...
},{"./zlib/inflate":"GIDK","./utils/common":"tbG5","./utils/strings":"Q3ZD","./zlib/constants":"xUUw","./zlib/messages":"gMAY","./zlib/zstream":"bdtv","./zlib/gzheader":"WIli"}],"JAiC":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=a(require("@babel/runtime/helpers/classCallCheck")),t=a(require("@babel/runtime/helpers/createClass")),r=a(require("@babel/runtime/helpers/inherits")),u=a(require("@babel/runtime/helpers/possibleConstructorReturn")),n=a(require("@babel/runtime/helpers/getPrototypeOf")),l=require("pako/lib/inflate"),i=a(require("./basedecoder"));function a(e){return e&&e.__esModule?e:{default:e}}function f(e){var t=o();return function(){var r,l=(0,n.default)(e);if(t){var i=(0,n.default)(this).constructor;r=Reflect.construct(l,arguments,i)}else r=l.apply(this,arguments);return(0,u.default)(this,r)}}function o(){if("undefined"==typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(e){return!1}}var c=function(u){(0,r.default)(i,u);var n=f(i);function i(){return(0,e.default)(this,i),n.apply(this,arguments)}return(0,t.default)(i,[{key:"decodeBlock",value:function(e){return(0,l.inflate)(new Uint8Array(e)).buffer}}]),i}(i.default);exports.default=c;
},{"@babel/runtime/helpers/classCallCheck":"fcMS","@babel/runtime/helpers/createClass":"P8NW","@babel/runtime/helpers/inherits":"d4H2","@babel/runtime/helpers/possibleConstructorReturn":"pxk2","@babel/runtime/helpers/getPrototypeOf":"UJE0","pako/lib/inflate":"faQk","./basedecoder":"FJDe"}],"OcPz":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.getDecoder=u;var e=s(require("./raw")),r=s(require("./lzw")),t=s(require("./jpeg")),n=s(require("./deflate")),o=s(require("./packbits"));function s(e){return e&&e.__esModule?e:{default:e}}function u(s){switch(s.Compression){case void 0:case 1:return new e.default;case 5:return new r.default(s);case 6:throw new Error("old style JPEG compression is not supported.");case 7:return new t.default(s);case 8:case 32946:return new n.default;case 32773:return new o.default;default:throw new Error("Unknown compression method identifier: ".concat(s.Compression))}}
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=u(require("@babel/runtime/helpers/slicedToArray")),t=u(require("@babel/runtime/regenerator")),r=u(require("@babel/runtime/helpers/asyncToGenerator")),i=u(require("@babel/runtime/helpers/classCallCheck")),a=u(require("@babel/runtime/helpers/createClass")),n=u(require("txml")),o=require("./globals"),s=require("./rgb"),l=require("./compression"),h=require("./resample");function u(e){return e&&e.__esModule?e:{default:e}}function c(e,t,r){for(var i=0,a=t;a<r;++a)i+=e[a];return i}function f(e,t,r){switch(e){case 1:switch(t){case 8:return new Uint8Array(r);case 16:return new Uint16Array(r);case 32:return new Uint32Array(r)}break;case 2:switch(t){case 8:return new Int8Array(r);case 16:return new Int16Array(r);case 32:return new Int32Array(r)}break;case 3:switch(t){case 32:return new Float32Array(r);case 64:return new Float64Array(r)}}throw Error("Unsupported data format/bitsPerSample")}var p=function(){function u(e,t,r,a,n,o){(0,i.default)(this,u),this.fileDirectory=e,this.geoKeys=t,this.dataView=r,this.littleEndian=a,this.tiles=n?{}:null,this.isTiled=!e.StripOffsets;var s=e.PlanarConfiguration;if(this.planarConfiguration=void 0===s?1:s,1!==this.planarConfiguration&&2!==this.planarConfiguration)throw new Error("Invalid planar configuration.");this.source=o}return(0,a.default)(u,[{key:"getFileDirectory",value:function(){return this.fileDirectory}},{key:"getGeoKeys",value:function(){return this.geoKeys}},{key:"getWidth",value:function(){return this.fileDirectory.ImageWidth}},{key:"getHeight",value:function(){return this.fileDirectory.ImageLength}},{key:"getSamplesPerPixel",value:function(){return this.fileDirectory.SamplesPerPixel}},{key:"getTileWidth",value:function(){return this.isTiled?this.fileDirectory.TileWidth:this.getWidth()}},{key:"getTileHeight",value:function(){return this.isTiled?this.fileDirectory.TileLength:void 0!==this.fileDirectory.RowsPerStrip?Math.min(this.fileDirectory.RowsPerStrip,this.getHeight()):this.getHeight()}},{key:"getBytesPerPixel",value:function(){for(var e=0,t=0;t<this.fileDirectory.BitsPerSample.length;++t){var r=this.fileDirectory.BitsPerSample[t];if(r%8!=0)throw new Error("Sample bit-width of ".concat(r," is not supported."));if(r!==this.fileDirectory.BitsPerSample[0])throw new Error("Differing size of samples in a pixel are not supported.");e+=r}return e/8}},{key:"getSampleByteSize",value:function(e){if(e>=this.fileDirectory.BitsPerSample.length)throw new RangeError("Sample index ".concat(e," is out of range."));var t=this.fileDirectory.BitsPerSample[e];if(t%8!=0)throw new Error("Sample bit-width of ".concat(t," is not supported."));return t/8}},{key:"getReaderForSample",value:function(e){var t=this.fileDirectory.SampleFormat?this.fileDirectory.SampleFormat[e]:1,r=this.fileDirectory.BitsPerSample[e];switch(t){case 1:switch(r){case 8:return DataView.prototype.getUint8;case 16:return DataView.prototype.getUint16;case 32:return DataView.prototype.getUint32}break;case 2:switch(r){case 8:return DataView.prototype.getInt8;case 16:return DataView.prototype.getInt16;case 32:return DataView.prototype.getInt32}break;case 3:switch(r){case 32:return DataView.prototype.getFloat32;case 64:return DataView.prototype.getFloat64}}throw Error("Unsupported data format/bitsPerSample")}},{key:"getArrayForSample",value:function(e,t){return f(this.fileDirectory.SampleFormat?this.fileDirectory.SampleFormat[e]:1,this.fileDirectory.BitsPerSample[e],t)}},{key:"getTileOrStrip",value:function(){var e=(0,r.default)(t.default.mark(function e(r,i,a,n,o){var s,l,h,u,c,f,p,g;return t.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return s=Math.ceil(this.getWidth()/this.getTileWidth()),l=Math.ceil(this.getHeight()/this.getTileHeight()),u=this.tiles,1===this.planarConfiguration?h=i*s+r:2===this.planarConfiguration&&(h=a*s*l+i*s+r),this.isTiled?(c=this.fileDirectory.TileOffsets[h],f=this.fileDirectory.TileByteCounts[h]):(c=this.fileDirectory.StripOffsets[h],f=this.fileDirectory.StripByteCounts[h]),e.next=7,this.source.fetch(c,f,!1,o);case 7:if(p=e.sent,!o||!o.aborted){e.next=10;break}return e.abrupt("return",{x:r,y:i,sample:a,data:[]});case 10:return null===u?g=n.decode(this.fileDirectory,p):u[h]||(g=n.decode(this.fileDirectory,p),u[h]=g),e.t0=r,e.t1=i,e.t2=a,e.next=16,g;case 16:return e.t3=e.sent,e.abrupt("return",{x:e.t0,y:e.t1,sample:e.t2,data:e.t3});case 18:case"end":return e.stop()}},e,this)}));return function(t,r,i,a,n){return e.apply(this,arguments)}}()},{key:"_readRaster",value:function(){var e=(0,r.default)(t.default.mark(function e(r,i,a,n,o,s,l,u,f){var p,g,d,y,m,w,v,D,b,k,x,M,S,T,I,P,A,C,E=this;return t.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:for(p=this.getTileWidth(),g=this.getTileHeight(),d=Math.max(Math.floor(r[0]/p),0),y=Math.min(Math.ceil(r[2]/p),Math.ceil(this.getWidth()/this.getTileWidth())),m=Math.max(Math.floor(r[1]/g),0),w=Math.min(Math.ceil(r[3]/g),Math.ceil(this.getHeight()/this.getTileHeight())),v=r[2]-r[0],D=this.getBytesPerPixel(),b=[],k=[],x=0;x<i.length;++x)1===this.planarConfiguration?b.push(c(this.fileDirectory.BitsPerSample,0,i[x])/8):b.push(0),k.push(this.getReaderForSample(i[x]));for(M=[],S=this.littleEndian,T=m;T<w;++T)for(I=d;I<y;++I)for(P=function(e){var t=e,s=i[e];2===E.planarConfiguration&&(D=E.getSampleByteSize(s));var l=E.getTileOrStrip(I,T,s,o,f);M.push(l),l.then(function(e){if(!f||!f.aborted)for(var o=e.data,s=new DataView(o),l=e.y*g,h=e.x*p,u=(e.y+1)*g,c=(e.x+1)*p,d=k[t],y=Math.min(g,g-(u-r[3])),m=Math.min(p,p-(c-r[2])),w=Math.max(0,r[1]-l);w<y;++w)for(var x=Math.max(0,r[0]-h);x<m;++x){var M=(w*p+x)*D,T=d.call(s,M+b[t],S),I=void 0;n?(I=(w+l-r[1])*v*i.length+(x+h-r[0])*i.length+t,a[I]=T):(I=(w+l-r[1])*v+x+h-r[0],a[t][I]=T)}})},A=0;A<i.length;++A)P(A);return e.next=16,Promise.all(M);case 16:if(!f||!f.aborted){e.next=18;break}return e.abrupt("return",new a.constructor(0));case 18:if(!(s&&r[2]-r[0]!==s||l&&r[3]-r[1]!==l)){e.next=23;break}return(C=n?(0,h.resampleInterleaved)(a,r[2]-r[0],r[3]-r[1],s,l,i.length,u):(0,h.resample)(a,r[2]-r[0],r[3]-r[1],s,l,u)).width=s,C.height=l,e.abrupt("return",C);case 23:return a.width=s||r[2]-r[0],a.height=l||r[3]-r[1],e.abrupt("return",a);case 26:case"end":return e.stop()}},e,this)}));return function(t,r,i,a,n,o,s,l,h){return e.apply(this,arguments)}}()},{key:"readRasters",value:function(){var e=(0,r.default)(t.default.mark(function e(){var r,i,a,n,o,s,h,u,c,p,g,d,y,m,w,v,D,b,k,x,M,S,T,I,P,A=arguments;return t.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=A.length>0&&void 0!==A[0]?A[0]:{},i=r.window,a=r.samples,n=void 0===a?[]:a,o=r.interleave,s=r.pool,h=void 0===s?null:s,u=r.width,c=r.height,p=r.resampleMethod,g=r.fillValue,d=r.signal,!((y=i||[0,0,this.getWidth(),this.getHeight()])[0]>y[2]||y[1]>y[3])){e.next=4;break}throw new Error("Invalid subsets");case 4:if(m=y[2]-y[0],w=y[3]-y[1],v=m*w,n&&n.length){e.next=11;break}for(D=0;D<this.fileDirectory.SamplesPerPixel;++D)n.push(D);e.next=18;break;case 11:b=0;case 12:if(!(b<n.length)){e.next=18;break}if(!(n[b]>=this.fileDirectory.SamplesPerPixel)){e.next=15;break}return e.abrupt("return",Promise.reject(new RangeError("Invalid sample index '".concat(n[b],"'."))));case 15:++b,e.next=12;break;case 18:if(o)x=this.fileDirectory.SampleFormat?Math.max.apply(null,this.fileDirectory.SampleFormat):1,M=Math.max.apply(null,this.fileDirectory.BitsPerSample),k=f(x,M,v*n.length),g&&k.fill(g);else for(k=[],S=0;S<n.length;++S)T=this.getArrayForSample(n[S],v),Array.isArray(g)&&S<g.length?T.fill(g[S]):g&&!Array.isArray(g)&&T.fill(g),k.push(T);return I=h||(0,l.getDecoder)(this.fileDirectory),e.next=22,this._readRaster(y,n,k,o,I,u,c,p,d);case 22:return P=e.sent,e.abrupt("return",P);case 24:case"end":return e.stop()}},e,this)}));return function(){return e.apply(this,arguments)}}()},{key:"readRGB",value:function(){var e=(0,r.default)(t.default.mark(function e(){var r,i,a,n,l,h,u,c,f,p,g,d,y,m,w,v,D,b,k,x,M=arguments;return t.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(r=M.length>0&&void 0!==M[0]?M[0]:{},i=r.window,a=r.pool,n=void 0===a?null:a,l=r.width,h=r.height,u=r.resampleMethod,c=r.enableAlpha,f=void 0!==c&&c,p=r.signal,!((g=i||[0,0,this.getWidth(),this.getHeight()])[0]>g[2]||g[1]>g[3])){e.next=4;break}throw new Error("Invalid subsets");case 4:if((d=this.fileDirectory.PhotometricInterpretation)!==o.photometricInterpretations.RGB){e.next=9;break}if(y=[0,1,2],this.fileDirectory.ExtraSamples!==o.ExtraSamplesValues.Unspecified&&f)for(y=[],m=0;m<this.fileDirectory.BitsPerSample.length;m+=1)y.push(m);return e.abrupt("return",this.readRasters({window:i,interleave:!0,samples:y,pool:n,width:l,height:h,signal:p}));case 9:e.t0=d,e.next=e.t0===o.photometricInterpretations.WhiteIsZero?12:e.t0===o.photometricInterpretations.BlackIsZero?12:e.t0===o.photometricInterpretations.Palette?12:e.t0===o.photometricInterpretations.CMYK?14:e.t0===o.photometricInterpretations.YCbCr?16:e.t0===o.photometricInterpretations.CIELab?16:18;break;case 12:return w=[0],e.abrupt("break",19);case 14:return w=[0,1,2,3],e.abrupt("break",19);case 16:return w=[0,1,2],e.abrupt("break",19);case 18:throw new Error("Invalid or unsupported photometric interpretation.");case 19:return v={window:g,interleave:!0,samples:w,pool:n,width:l,height:h,resampleMethod:u,signal:p},D=this.fileDirectory,e.next=23,this.readRasters(v);case 23:b=e.sent,k=Math.pow(2,this.fileDirectory.BitsPerSample[0]),e.t1=d,e.next=e.t1===o.photometricInterpretations.WhiteIsZero?28:e.t1===o.photometricInterpretations.BlackIsZero?30:e.t1===o.photometricInterpretations.Palette?32:e.t1===o.photometricInterpretations.CMYK?34:e.t1===o.photometricInterpretations.YCbCr?36:e.t1===o.photometricInterpretations.CIELab?38:40;break;case 28:return x=(0,s.fromWhiteIsZero)(b,k),e.abrupt("break",41);case 30:return x=(0,s.fromBlackIsZero)(b,k),e.abrupt("break",41);case 32:return x=(0,s.fromPalette)(b,D.ColorMap),e.abrupt("break",41);case 34:return x=(0,s.fromCMYK)(b),e.abrupt("break",41);case 36:return x=(0,s.fromYCbCr)(b),e.abrupt("break",41);case 38:return x=(0,s.fromCIELab)(b),e.abrupt("break",41);case 40:throw new Error("Unsupported photometric interpretation.");case 41:return x.width=b.width,x.height=b.height,e.abrupt("return",x);case 44:case"end":return e.stop()}},e,this)}));return function(){return e.apply(this,arguments)}}()},{key:"getTiePoints",value:function(){if(!this.fileDirectory.ModelTiepoint)return[];for(var e=[],t=0;t<this.fileDirectory.ModelTiepoint.length;t+=6)e.push({i:this.fileDirectory.ModelTiepoint[t],j:this.fileDirectory.ModelTiepoint[t+1],k:this.fileDirectory.ModelTiepoint[t+2],x:this.fileDirectory.ModelTiepoint[t+3],y:this.fileDirectory.ModelTiepoint[t+4],z:this.fileDirectory.ModelTiepoint[t+5]});return e}},{key:"getGDALMetadata",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,t={};if(!this.fileDirectory.GDAL_METADATA)return null;var r=this.fileDirectory.GDAL_METADATA,i=(0,n.default)(r.substring(0,r.length-1));if(!i[0].tagName)throw new Error("Failed to parse GDAL metadata XML.");var a=i[0];if("GDALMetadata"!==a.tagName)throw new Error("Unexpected GDAL metadata XML tag.");var o=a.children.filter(function(e){return"Item"===e.tagName});null!==e&&(o=o.filter(function(t){return Number(t.attributes.sample)===e}));for(var s=0;s<o.length;++s){var l=o[s];t[l.attributes.name]=l.children[0]}return t}},{key:"getGDALNoData",value:function(){if(!this.fileDirectory.GDAL_NODATA)return null;var e=this.fileDirectory.GDAL_NODATA;return Number(e.substring(0,e.length-1))}},{key:"getOrigin",value:function(){var e=this.fileDirectory.ModelTiepoint,t=this.fileDirectory.ModelTransformation;if(e&&6===e.length)return[e[3],e[4],e[5]];if(t)return[t[3],t[7],t[11]];throw new Error("The image does not have an affine transformation.")}},{key:"getResolution",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=this.fileDirectory.ModelPixelScale,i=this.fileDirectory.ModelTransformation;if(r)return[r[0],-r[1],r[2]];if(i)return[i[0],i[5],i[10]];if(t){var a=t.getResolution(),n=(0,e.default)(a,3),o=n[0],s=n[1],l=n[2];return[o*t.getWidth()/this.getWidth(),s*t.getHeight()/this.getHeight(),l*t.getWidth()/this.getWidth()]}throw new Error("The image does not have an affine transformation.")}},{key:"pixelIsArea",value:function(){return 1===this.geoKeys.GTRasterTypeGeoKey}},{key:"getBoundingBox",value:function(){var e=this.getOrigin(),t=this.getResolution(),r=e[0],i=e[1],a=r+t[0]*this.getWidth(),n=i+t[1]*this.getHeight();return[Math.min(r,a),Math.min(i,n),Math.max(r,a),Math.max(i,n)]}}]),u}(),g=p;exports.default=g;
},{"@babel/runtime/helpers/slicedToArray":"HETk","@babel/runtime/regenerator":"PMvg","@babel/runtime/helpers/asyncToGenerator":"agGE","@babel/runtime/helpers/classCallCheck":"fcMS","@babel/runtime/helpers/createClass":"P8NW","txml":"JO74","./globals":"j27V","./rgb":"fpBl","./compression":"FGCZ","./resample":"OQju"}],"dqpX":[function(require,module,exports) {
...
},{"@babel/runtime/helpers/classCallCheck":"fcMS","@babel/runtime/helpers/createClass":"P8NW"}],"z2GM":[function(require,module,exports) {
...
},{}],"kdjL":[function(require,module,exports) {
...
},{"./serializers":"z2GM"}],"LQHy":[function(require,module,exports) {
...
},{}],"XK2w":[function(require,module,exports) {
...
},{"./get-bundle-url.browser":"LQHy"}],"IAgR":[function(require,module,exports) {
...
},{"./common":"Kest","process":"pBGv"}],"sfrJ":[function(require,module,exports) {
...
},{}],"lj3f":[function(require,module,exports) {
...
},{}],"B9l3":[function(require,module,exports) {
...
},{"./_symbols":"lj3f"}],"QC75":[function(require,module,exports) {
...
},{}],"apmd":[function(require,module,exports) {
...
},{"./_scheduler":"sfrJ","./observable":"B9l3","./unsubscribe":"QC75"}],"FgiE":[function(require,module,exports) {
...
},{"./_symbols":"lj3f"}],"ltny":[function(require,module,exports) {
...
},{"./_scheduler":"sfrJ","./_util":"FgiE","./observable":"B9l3","./unsubscribe":"QC75"}],"jAhG":[function(require,module,exports) {
...
},{"./observable":"B9l3"}],"aP59":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=require("./_scheduler"),r=n(require("./observable")),t=n(require("./unsubscribe"));function n(e){return e&&e.__esModule?e:{default:e}}var u=function(e,r,t,n){return new(t||(t=Promise))(function(u,o){function c(e){try{l(n.next(e))}catch(r){o(r)}}function i(e){try{l(n.throw(e))}catch(r){o(r)}}function l(e){e.done?u(e.value):new t(function(r){r(e.value)}).then(c,i)}l((n=n.apply(e,r||[])).next())})};function o(n){return o=>new r.default(r=>{const c=new e.AsyncSerialScheduler(r),i=o.subscribe({complete(){c.complete()},error(e){c.error(e)},next(e){c.schedule(r=>u(this,void 0,void 0,function*(){const t=yield n(e);r(t)}))}});return()=>(0,t.default)(i)})}var c=o;exports.default=c;
},{"./_scheduler":"sfrJ","./observable":"B9l3","./unsubscribe":"QC75"}],"Rg1v":[function(require,module,exports) {
...
},{"./observable":"B9l3","./unsubscribe":"QC75"}],"wtHd":[function(require,module,exports) {
...
},{"./observable":"B9l3"}],"NgdC":[function(require,module,exports) {
...
},{"./observable":"B9l3","./subject":"wtHd","./unsubscribe":"QC75"}],"b7o0":[function(require,module,exports) {
...
},{"./_scheduler":"sfrJ","./observable":"B9l3","./unsubscribe":"QC75"}],"cyO3":[function(require,module,exports) {
...
},{"./filter":"apmd","./flatMap":"ltny","./interval":"jAhG","./map":"aP59","./merge":"Rg1v","./multicast":"NgdC","./observable":"B9l3","./scan":"b7o0","./subject":"wtHd","./unsubscribe":"QC75"}],"vpgy":[function(require,module,exports) {
...
},{}],"UYCO":[function(require,module,exports) {
...
},{}],"fmdM":[function(require,module,exports) {
...
},{}],"LBuu":[function(require,module,exports) {
...
},{"../symbols":"fmdM"}],"EB3M":[function(require,module,exports) {
...
},{"debug":"jcLW","observable-fns":"cyO3","../ponyfills":"vpgy","./implementation":"XK2w","./pool-types":"UYCO","./thread":"LBuu"}],"PRGP":[function(require,module,exports) {
...
},{}],"ZLGT":[function(require,module,exports) {
...
},{"../symbols":"fmdM"}],"zXl4":[function(require,module,exports) {
...
},{"observable-fns":"cyO3"}],"qW1u":[function(require,module,exports) {
...
},{"./symbols":"fmdM"}],"fUdt":[function(require,module,exports) {
...
},{}],"iMbm":[function(require,module,exports) {
...
},{"debug":"jcLW","observable-fns":"cyO3","../common":"kdjL","../observable-promise":"zXl4","../transferable":"qW1u","../types/messages":"fUdt"}],"a83E":[function(require,module,exports) {
var process = require("process");
...
},{"debug":"jcLW","observable-fns":"cyO3","../common":"kdjL","../promise":"PRGP","../symbols":"fmdM","../types/master":"ZLGT","./invocation-proxy":"iMbm","process":"pBGv"}],"HfK0":[function(require,module,exports) {
...
},{"./implementation":"XK2w","./pool":"EB3M","./spawn":"a83E","./thread":"LBuu"}],"JZ8d":[function(require,module,exports) {
...
},{"symbol-observable":"LkZ7"}],"AZa4":[function(require,module,exports) {
...
},{}],"l5pR":[function(require,module,exports) {
var process = require("process");
...
},{"is-observable":"UALh","../common":"kdjL","../transferable":"qW1u","../types/messages":"fUdt","./implementation":"AZa4","process":"pBGv"}],"CqwR":[function(require,module,exports) {
...
},{"./common":"kdjL","./master/index":"HfK0","./worker/index":"l5pR","./serializers":"z2GM","./transferable":"qW1u"}],"dHPO":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=a(require("@babel/runtime/regenerator")),r=a(require("@babel/runtime/helpers/asyncToGenerator")),t=a(require("@babel/runtime/helpers/classCallCheck")),n=a(require("@babel/runtime/helpers/createClass")),u=require("threads");function a(e){return e&&e.__esModule?e:{default:e}}var o="undefined"!=typeof navigator?navigator.hardwareConcurrency:null,i=function(){function a(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:o,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:new u.Worker("decoder.worker.180f1b54.js");(0,t.default)(this,a),this.pool=(0,u.Pool)(function(){return(0,u.spawn)(r)},e)}return(0,n.default)(a,[{key:"decode",value:function(){var t=(0,r.default)(e.default.mark(function t(n,a){var o=this;return e.default.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return t.abrupt("return",new Promise(function(t,i){o.pool.queue(function(){var o=(0,r.default)(e.default.mark(function r(o){var s;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,o(n,(0,u.Transfer)(a));case 3:s=e.sent,t(s),e.next=10;break;case 7:e.prev=7,e.t0=e.catch(0),i(e.t0);case 10:case"end":return e.stop()}},r,null,[[0,7]])}));return function(e){return o.apply(this,arguments)}}())}));case 1:case"end":return t.stop()}},t)}));return function(e,r){return t.apply(this,arguments)}}()},{key:"destroy",value:function(){this.pool.terminate(!0)}}]),a}(),s=i;exports.default=s;
},{"@babel/runtime/regenerator":"PMvg","@babel/runtime/helpers/asyncToGenerator":"agGE","@babel/runtime/helpers/classCallCheck":"fcMS","@babel/runtime/helpers/createClass":"P8NW","threads":"CqwR","./decoder.worker.js":[["decoder.worker.180f1b54.js","LHx9"],"decoder.worker.180f1b54.js.map","LHx9"]}],"p5a1":[function(require,module,exports) {
var global = arguments[3];
...
},{"process":"pBGv"}],"Nqn4":[function(require,module,exports) {
...
},{"buffer":"dskh"}],"CQMM":[function(require,module,exports) {
...
},{"safe-buffer":"Nqn4","util":"rDCW"}],"lCUh":[function(require,module,exports) {
...
},{"process-nextick-args":"Yj0v"}],"jPmE":[function(require,module,exports) {
var process = require("process");
...
},{"process-nextick-args":"Yj0v","core-util-is":"Q14w","inherits":"Bm0n","util-deprecate":"yM1o","./internal/streams/stream":"ExO1","safe-buffer":"Nqn4","./internal/streams/destroy":"lCUh","./_stream_duplex":"Jcj8","process":"pBGv"}],"Jcj8":[function(require,module,exports) {
...
"use strict";var t=require("safe-buffer").Buffer,e=t.isEncoding||function(t){switch((t=""+t)&&t.toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":case"raw":return!0;default:return!1}};function s(t){if(!t)return"utf8";for(var e;;)switch(t){case"utf8":case"utf-8":return"utf8";case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return"utf16le";case"latin1":case"binary":return"latin1";case"base64":case"ascii":case"hex":return t;default:if(e)return;t=(""+t).toLowerCase(),e=!0}}function i(i){var a=s(i);if("string"!=typeof a&&(t.isEncoding===e||!e(i)))throw new Error("Unknown encoding: "+i);return a||i}function a(e){var s;switch(this.encoding=i(e),this.encoding){case"utf16le":this.text=c,this.end=f,s=4;break;case"utf8":this.fillLast=l,s=4;break;case"base64":this.text=d,this.end=g,s=3;break;default:return this.write=N,void(this.end=v)}this.lastNeed=0,this.lastTotal=0,this.lastChar=t.allocUnsafe(s)}function r(t){return t<=127?0:t>>5==6?2:t>>4==14?3:t>>3==30?4:t>>6==2?-1:-2}function n(t,e,s){var i=e.length-1;if(i<s)return 0;var a=r(e[i]);return a>=0?(a>0&&(t.lastNeed=a-1),a):--i<s||-2===a?0:(a=r(e[i]))>=0?(a>0&&(t.lastNeed=a-2),a):--i<s||-2===a?0:(a=r(e[i]))>=0?(a>0&&(2===a?a=0:t.lastNeed=a-3),a):0}function h(t,e,s){if(128!=(192&e[0]))return t.lastNeed=0,"�";if(t.lastNeed>1&&e.length>1){if(128!=(192&e[1]))return t.lastNeed=1,"�";if(t.lastNeed>2&&e.length>2&&128!=(192&e[2]))return t.lastNeed=2,"�"}}function l(t){var e=this.lastTotal-this.lastNeed,s=h(this,t,e);return void 0!==s?s:this.lastNeed<=t.length?(t.copy(this.lastChar,e,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal)):(t.copy(this.lastChar,e,0,t.length),void(this.lastNeed-=t.length))}function u(t,e){var s=n(this,t,e);if(!this.lastNeed)return t.toString("utf8",e);this.lastTotal=s;var i=t.length-(s-this.lastNeed);return t.copy(this.lastChar,0,i),t.toString("utf8",e,i)}function o(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+"�":e}function c(t,e){if((t.length-e)%2==0){var s=t.toString("utf16le",e);if(s){var i=s.charCodeAt(s.length-1);if(i>=55296&&i<=56319)return this.lastNeed=2,this.lastTotal=4,this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1],s.slice(0,-1)}return s}return this.lastNeed=1,this.lastTotal=2,this.lastChar[0]=t[t.length-1],t.toString("utf16le",e,t.length-1)}function f(t){var e=t&&t.length?this.write(t):"";if(this.lastNeed){var s=this.lastTotal-this.lastNeed;return e+this.lastChar.toString("utf16le",0,s)}return e}function d(t,e){var s=(t.length-e)%3;return 0===s?t.toString("base64",e):(this.lastNeed=3-s,this.lastTotal=3,1===s?this.lastChar[0]=t[t.length-1]:(this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1]),t.toString("base64",e,t.length-s))}function g(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+this.lastChar.toString("base64",0,3-this.lastNeed):e}function N(t){return t.toString(this.encoding)}function v(t){return t&&t.length?this.write(t):""}exports.StringDecoder=a,a.prototype.write=function(t){if(0===t.length)return"";var e,s;if(this.lastNeed){if(void 0===(e=this.fillLast(t)))return"";s=this.lastNeed,this.lastNeed=0}else s=0;return s<t.length?e?e+this.text(t,s):this.text(t,s):e||""},a.prototype.end=o,a.prototype.text=u,a.prototype.fillLast=function(t){if(this.lastNeed<=t.length)return t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal);t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,t.length),this.lastNeed-=t.length};
},{"safe-buffer":"Nqn4"}],"YrHu":[function(require,module,exports) {
...
},{"process-nextick-args":"Yj0v","isarray":"REa7","events":"FRpO","./internal/streams/stream":"ExO1","safe-buffer":"Nqn4","core-util-is":"Q14w","inherits":"Bm0n","util":"rDCW","./internal/streams/BufferList":"CQMM","./internal/streams/destroy":"lCUh","./_stream_duplex":"Jcj8","string_decoder/":"OUJr","process":"pBGv"}],"wBib":[function(require,module,exports) {
...
},{"./capability":"p5a1","inherits":"Bm0n","readable-stream":"JaqQ","process":"pBGv","buffer":"dskh"}],"AH4k":[function(require,module,exports) {
...
},{"./capability":"p5a1","inherits":"Bm0n","./response":"UxIR","readable-stream":"JaqQ","to-arraybuffer":"AH4k","buffer":"dskh","process":"pBGv"}],"K5Tb":[function(require,module,exports) {
...
},{"http":"KKrj","url":"Mej7"}],"cUx7":[function(require,module,exports) {

"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.makeFetchSource=S,exports.makeXHRSource=q,exports.makeHttpSource=R,exports.makeRemoteSource=A,exports.makeBufferSource=z,exports.makeFileSource=B,exports.makeFileReaderSource=I;var e=l(require("@babel/runtime/helpers/slicedToArray")),t=l(require("@babel/runtime/helpers/defineProperty")),r=l(require("@babel/runtime/regenerator")),n=l(require("@babel/runtime/helpers/classCallCheck")),a=l(require("@babel/runtime/helpers/createClass")),u=l(require("@babel/runtime/helpers/asyncToGenerator")),o=require("buffer"),s=require("fs"),i=l(require("http")),c=l(require("https")),f=l(require("url"));function l(e){return e&&e.__esModule?e:{default:e}}function d(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r.push.apply(r,n)}return r}function h(e){for(var r=1;r<arguments.length;r++){var n=null!=arguments[r]?arguments[r]:{};r%2?d(Object(n),!0).forEach(function(r){(0,t.default)(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):d(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}function b(e,t){var r;if("undefined"==typeof Symbol||null==e[Symbol.iterator]){if(Array.isArray(e)||(r=p(e))||t&&e&&"number"==typeof e.length){r&&(e=r);var n=0,a=function(){};return{s:a,n:function(){return n>=e.length?{done:!0}:{done:!1,value:e[n++]}},e:function(e){throw e},f:a}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var u,o=!0,s=!1;return{s:function(){r=e[Symbol.iterator]()},n:function(){var e=r.next();return o=e.done,e},e:function(e){s=!0,u=e},f:function(){try{o||null==r.return||r.return()}finally{if(s)throw u}}}}function p(e,t){if(e){if("string"==typeof e)return v(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?v(e,t):void 0}}function v(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,n=new Array(t);r<t;r++)n[r]=e[r];return n}function k(e){if(e.every(Boolean)){var t=new AbortController;t.count=e.length;var r,n=b(e);try{for(n.s();!(r=n.n()).done;){var a=r.value;a.aborted?u():a.addEventListener("abort",u)}}catch(o){n.e(o)}finally{n.f()}return t.signal}function u(){if(t.count-=1,0===t.count){t.abort();var r,n=b(e);try{for(n.s();!(r=n.n()).done;){r.value.removeEventListener("abort",u)}}catch(o){n.e(o)}finally{n.f()}}}}function g(e,t,r){var n,a=t+r,u=new ArrayBuffer(r),o=new Uint8Array(u),s=b(e);try{for(s.s();!(n=s.n()).done;){var i=n.value,c=i.offset-t,f=i.top-a,l=0,d=0,h=void 0;c<0?l=-c:c>0&&(d=c),h=f<0?i.length-l:a-i.offset-l;var p=new Uint8Array(i.data,l,h);o.set(p,d)}}catch(v){s.e(v)}finally{s.f()}return u}function y(e){if(0===e.length)return[];var t=[],r=[];t.push(r);for(var n=0;n<e.length;++n)0===n||e[n]===e[n-1]+1?r.push(e[n]):(r=[e[n]],t.push(r));return t}function w(e){return m.apply(this,arguments)}function m(){return(m=(0,u.default)(r.default.mark(function e(t){return r.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",new Promise(function(e){return setTimeout(e,t)}));case 1:case"end":return e.stop()}},e)}))).apply(this,arguments)}var x=function(){function e(t){var a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},o=a.blockSize,s=void 0===o?65536:o,i=a.getFileSize,c=void 0===i?(0,u.default)(r.default.mark(function e(){return r.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",null);case 1:case"end":return e.stop()}},e)})):i;(0,n.default)(this,e),this.retrievalFunction=t,this.blockSize=s,this.blockRequests=new Map,this.blocks=new Map,this.signals=new Map,this.abortedBlockIds=new Set,this.blockIdsAwaitingRequest=null,this.fileSizePromise=c()}return(0,a.default)(e,[{key:"fetch",value:function(){var e=(0,u.default)(r.default.mark(function e(t,n){var a,o,s,i,c,f,l,d,h,p,v,m,x,S,q,R,A,z,P,O,j,B,I=this,E=arguments;return r.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return a=E.length>2&&void 0!==E[2]&&E[2],o=E.length>3?E[3]:void 0,e.next=4,this.fileSizePromise;case 4:for(s=e.sent,i=s?Math.min(t+n,s):t+n,c=Math.floor(t/this.blockSize)*this.blockSize,f=[],l=[],d=[],h=c;h<i;h+=this.blockSize)p=Math.floor(h/this.blockSize),this.blocks.has(p)||this.blockRequests.has(p)||(l.push(p),this.signals.has(p)?this.signals.get(p).push(o):this.signals.set(p,[o])),this.blockRequests.has(p)&&d.push(this.blockRequests.get(p)),f.push(p);if(this.blockIdsAwaitingRequest)for(v=0;v<l.length;++v)this.blockIdsAwaitingRequest.add(l[v]);else this.blockIdsAwaitingRequest=new Set(l);if(a){e.next=15;break}return e.next=15,w();case 15:if(this.blockIdsAwaitingRequest){m=y(Array.from(this.blockIdsAwaitingRequest).sort()),x=b(m);try{for(q=function(){for(var e=S.value,t=Array.from(new Set(e.map(function(e){return I.signals.get(e)}).flat())),n=I.requestData(e[0]*I.blockSize,e.length*I.blockSize,k(t)),a=function(t){var a=e[t];I.blockRequests.set(a,(0,u.default)(r.default.mark(function e(){var u,o,s,i;return r.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,n;case 3:u=e.sent,o=t*I.blockSize,s=Math.min(o+I.blockSize,u.data.byteLength),i=u.data.slice(o,s),I.blockRequests.delete(a),I.signals.delete(a),I.abortedBlockIds.delete(a),I.blocks.set(a,{data:i,offset:u.offset+o,length:i.byteLength,top:u.offset+s}),e.next=23;break;case 13:if(e.prev=13,e.t0=e.catch(0),"AbortError"!==e.t0.name){e.next=22;break}I.blocks.delete(a),I.blockRequests.delete(a),I.signals.delete(a),I.abortedBlockIds.add(a),e.next=23;break;case 22:throw e.t0;case 23:case"end":return e.stop()}},e,null,[[0,13]])}))())},o=0;o<e.length;++o)a(o)},x.s();!(S=x.n()).done;)q()}catch(L){x.e(L)}finally{x.f()}this.blockIdsAwaitingRequest=null}for(R=[],A=0,z=l;A<z.length;A++)P=z[A],this.blockRequests.has(P)&&R.push(this.blockRequests.get(P));return e.next=20,Promise.all(R);case 20:return e.next=22,Promise.all(d);case 22:if(O=f.map(function(e){return I.blocks.get(e)}),j=[],!O.some(function(e){return!e})){e.next=36;break}if(!o||o.aborted){e.next=29;break}f.forEach(function(e){if(I.abortedBlockIds.has(e)){var t=I.requestData(e*I.blockSize,I.blockSize);I.blockRequests.set(e,(0,u.default)(r.default.mark(function n(){var a,u,o;return r.default.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.next=2,t;case 2:a=r.sent,u=Math.min(I.blockSize,a.data.byteLength),o=a.data.slice(0,u),I.abortedBlockIds.delete(e),I.blocks.set(e,{data:o,offset:a.offset,length:o.byteLength,top:a.offset+u});case 7:case"end":return r.stop()}},n)}))()),j.push(I.blockRequests.get(e))}}),e.next=30;break;case 29:return e.abrupt("return",[]);case 30:return e.next=32,Promise.all(j);case 32:return B=f.map(function(e){return I.blocks.get(e)}),e.abrupt("return",g(B,t,n));case 36:return e.abrupt("return",g(O,t,n));case 37:case"end":return e.stop()}},e,this)}));return function(t,r){return e.apply(this,arguments)}}()},{key:"requestData",value:function(){var e=(0,u.default)(r.default.mark(function e(t,n,a){var u;return r.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,this.retrievalFunction(t,n,a);case 2:return(u=e.sent).length?u.length!==u.data.byteLength&&(u.data=u.data.slice(0,u.length)):u.length=u.data.byteLength,u.top=u.offset+u.length,e.abrupt("return",u);case 6:case"end":return e.stop()}},e,this)}));return function(t,r,n){return e.apply(this,arguments)}}()}]),e}();function S(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},a=n.headers,o=void 0===a?{}:a,s=n.blockSize;return new x(function(){var e=(0,u.default)(r.default.mark(function e(n,a,u){var s,i,c;return r.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,fetch(t,{headers:h(h({},o),{},{Range:"bytes=".concat(n,"-").concat(n+a-1)}),signal:u});case 2:if((s=e.sent).ok){e.next=7;break}throw new Error("Error fetching data.");case 7:if(206!==s.status){e.next=21;break}if(!s.arrayBuffer){e.next=14;break}return e.next=11,s.arrayBuffer();case 11:e.t0=e.sent,e.next=17;break;case 14:return e.next=16,s.buffer();case 16:e.t0=e.sent.buffer;case 17:return i=e.t0,e.abrupt("return",{data:i,offset:n,length:a});case 21:if(!s.arrayBuffer){e.next=27;break}return e.next=24,s.arrayBuffer();case 24:e.t1=e.sent,e.next=30;break;case 27:return e.next=29,s.buffer();case 29:e.t1=e.sent.buffer;case 30:return c=e.t1,e.abrupt("return",{data:c,offset:0,length:c.byteLength});case 32:case"end":return e.stop()}},e)}));return function(t,r,n){return e.apply(this,arguments)}}(),{blockSize:s,getFileSize:function(){var n=(0,u.default)(r.default.mark(function n(){var a,u,s,i,c;return r.default.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.next=2,fetch(t,{headers:h(h({},o),{},{Range:"bytes=0-1"})});case 2:if((a=r.sent).ok){r.next=7;break}throw new Error("Error fetching data.");case 7:if(206!==a.status){r.next=13;break}if(u=a.headers.get("content-range")){r.next=11;break}return r.abrupt("return",null);case 11:return s=u.split("/").slice(-1),i=(0,e.default)(s,1),c=i[0],r.abrupt("return",Number(c));case 13:case"end":return r.stop()}},n)}));return function(){return n.apply(this,arguments)}}()})}function q(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},a=n.headers,o=void 0===a?{}:a,s=n.blockSize;return new x(function(){var n=(0,u.default)(r.default.mark(function n(a,u){return r.default.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.abrupt("return",new Promise(function(r,n){var s=new XMLHttpRequest;s.open("GET",t),s.responseType="arraybuffer";for(var i=h(h({},o),{},{Range:"bytes=".concat(a,"-").concat(a+u-1)}),c=0,f=Object.entries(i);c<f.length;c++){var l=(0,e.default)(f[c],2),d=l[0],b=l[1];s.setRequestHeader(d,b)}s.onload=function(){var e=s.response;206===s.status?r({data:e,offset:a,length:u}):r({data:e,offset:0,length:e.byteLength})},s.onerror=n,s.send()}));case 1:case"end":return r.stop()}},n)}));return function(e,t){return n.apply(this,arguments)}}(),{blockSize:s})}function R(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=t.headers,a=void 0===n?{}:n,s=t.blockSize;return new x(function(){var t=(0,u.default)(r.default.mark(function t(n,u){return r.default.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return t.abrupt("return",new Promise(function(t,r){var s=f.default.parse(e);("http:"===s.protocol?i.default:c.default).get(h(h({},s),{},{headers:h(h({},a),{},{Range:"bytes=".concat(n,"-").concat(n+u-1)})}),function(e){var r=[];e.on("data",function(e){r.push(e)}),e.on("end",function(){var e=o.Buffer.concat(r).buffer;t({data:e,offset:n,length:e.byteLength})})}).on("error",r)}));case 1:case"end":return t.stop()}},t)}));return function(e,r){return t.apply(this,arguments)}}(),{blockSize:s})}function A(e,t){var r=t.forceXHR;if("function"==typeof fetch&&!r)return S(e,t);if("undefined"!=typeof XMLHttpRequest)return q(e,t);if(i.default.get)return R(e,t);throw new Error("No remote source available")}function z(e){return{fetch:function(t,n){return(0,u.default)(r.default.mark(function a(){return r.default.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.abrupt("return",e.slice(t,t+n));case 1:case"end":return r.stop()}},a)}))()}}}function P(e){return new Promise(function(t,r){(0,s.close)(e,function(e){e?r(e):t()})})}function O(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:void 0;return new Promise(function(n,a){(0,s.open)(e,t,r,function(e,t){e?a(e):n(t)})})}function j(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];return new Promise(function(e,r){s.read.apply(void 0,t.concat([function(t,n,a){t?r(t):e({bytesRead:n,buffer:a})}]))})}function B(e){var t=O(e,"r");return{fetch:function(e,n){return(0,u.default)(r.default.mark(function a(){var u,s,i;return r.default.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.next=2,t;case 2:return u=r.sent,r.next=5,j(u,o.Buffer.alloc(n),0,n,e);case 5:return s=r.sent,i=s.buffer,r.abrupt("return",i.buffer);case 8:case"end":return r.stop()}},a)}))()},close:function(){return(0,u.default)(r.default.mark(function e(){var n;return r.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,t;case 2:return n=e.sent,e.next=5,P(n);case 5:return e.abrupt("return",e.sent);case 6:case"end":return e.stop()}},e)}))()}}}function I(e){return{fetch:function(t,n){return(0,u.default)(r.default.mark(function a(){return r.default.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.abrupt("return",new Promise(function(r,a){var u=e.slice(t,t+n),o=new FileReader;o.onload=function(e){return r(e.target.result)},o.onerror=a,o.readAsArrayBuffer(u)}));case 1:case"end":return r.stop()}},a)}))()}}}
},{"@babel/runtime/helpers/slicedToArray":"HETk","@babel/runtime/helpers/defineProperty":"IxO8","@babel/runtime/regenerator":"PMvg","@babel/runtime/helpers/classCallCheck":"fcMS","@babel/runtime/helpers/createClass":"P8NW","@babel/runtime/helpers/asyncToGenerator":"agGE","buffer":"dskh","fs":"rDCW","http":"KKrj","https":"wVMl","url":"Mej7"}],"FOZT":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.fromUrl=C,exports.fromArrayBuffer=j,exports.fromFile=G,exports.fromBlob=V,exports.fromUrls=K,exports.writeArrayBuffer=H,Object.defineProperty(exports,"Pool",{enumerable:!0,get:function(){return d.default}}),Object.defineProperty(exports,"getDecoder",{enumerable:!0,get:function(){return x.getDecoder}}),Object.defineProperty(exports,"setLogger",{enumerable:!0,get:function(){return v.setLogger}}),exports.rgb=exports.globals=exports.MultiGeoTIFF=exports.default=exports.GeoTIFF=void 0;var e=k(require("@babel/runtime/regenerator")),t=k(require("@babel/runtime/helpers/defineProperty")),r=k(require("@babel/runtime/helpers/slicedToArray")),n=k(require("@babel/runtime/helpers/asyncToGenerator")),a=k(require("@babel/runtime/helpers/createClass")),i=k(require("@babel/runtime/helpers/inherits")),s=k(require("@babel/runtime/helpers/possibleConstructorReturn")),u=k(require("@babel/runtime/helpers/getPrototypeOf")),f=k(require("@babel/runtime/helpers/wrapNativeSuper")),c=k(require("@babel/runtime/helpers/classCallCheck")),o=k(require("./geotiffimage")),l=k(require("./dataview64")),p=k(require("./dataslice")),d=k(require("./pool")),h=require("./source"),b=m(require("./globals"));exports.globals=b;var y=require("./geotiffwriter"),g=m(require("./rgb"));exports.rgb=g;var x=require("./compression"),v=require("./logging");function w(){if("function"!=typeof WeakMap)return null;var e=new WeakMap;return w=function(){return e},e}function m(e){if(e&&e.__esModule)return e;if(null===e||"object"!=typeof e&&"function"!=typeof e)return{default:e};var t=w();if(t&&t.has(e))return t.get(e);var r={},n=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var a in e)if(Object.prototype.hasOwnProperty.call(e,a)){var i=n?Object.getOwnPropertyDescriptor(e,a):null;i&&(i.get||i.set)?Object.defineProperty(r,a,i):r[a]=e[a]}return r.default=e,t&&t.set(e,r),r}function k(e){return e&&e.__esModule?e:{default:e}}function T(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),r.push.apply(r,n)}return r}function I(e){for(var r=1;r<arguments.length;r++){var n=null!=arguments[r]?arguments[r]:{};r%2?T(Object(n),!0).forEach(function(r){(0,t.default)(e,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):T(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}function O(e){var t=F();return function(){var r,n=(0,u.default)(e);if(t){var a=(0,u.default)(this).constructor;r=Reflect.construct(n,arguments,a)}else r=n.apply(this,arguments);return(0,s.default)(this,r)}}function F(){if("undefined"==typeof Reflect||!Reflect.construct)return!1;if(Reflect.construct.sham)return!1;if("function"==typeof Proxy)return!0;try{return Date.prototype.toString.call(Reflect.construct(Date,[],function(){})),!0}catch(e){return!1}}function D(e){switch(e){case b.fieldTypes.BYTE:case b.fieldTypes.ASCII:case b.fieldTypes.SBYTE:case b.fieldTypes.UNDEFINED:return 1;case b.fieldTypes.SHORT:case b.fieldTypes.SSHORT:return 2;case b.fieldTypes.LONG:case b.fieldTypes.SLONG:case b.fieldTypes.FLOAT:case b.fieldTypes.IFD:return 4;case b.fieldTypes.RATIONAL:case b.fieldTypes.SRATIONAL:case b.fieldTypes.DOUBLE:case b.fieldTypes.LONG8:case b.fieldTypes.SLONG8:case b.fieldTypes.IFD8:return 8;default:throw new RangeError("Invalid field type: ".concat(e))}}function A(e){var t=e.GeoKeyDirectory;if(!t)return null;for(var r={},n=4;n<=4*t[3];n+=4){var a=b.geoKeyNames[t[n]],i=t[n+1]?b.fieldTagNames[t[n+1]]:null,s=t[n+2],u=t[n+3],f=null;if(i){if(null==(f=e[i]))throw new Error("Could not get value of geoKey '".concat(a,"'."));"string"==typeof f?f=f.substring(u,u+s-1):f.subarray&&(f=f.subarray(u,u+s),1===s&&(f=f[0]))}else f=u;r[a]=f}return r}function S(e,t,r,n){var a=null,i=null,s=D(t);switch(t){case b.fieldTypes.BYTE:case b.fieldTypes.ASCII:case b.fieldTypes.UNDEFINED:a=new Uint8Array(r),i=e.readUint8;break;case b.fieldTypes.SBYTE:a=new Int8Array(r),i=e.readInt8;break;case b.fieldTypes.SHORT:a=new Uint16Array(r),i=e.readUint16;break;case b.fieldTypes.SSHORT:a=new Int16Array(r),i=e.readInt16;break;case b.fieldTypes.LONG:case b.fieldTypes.IFD:a=new Uint32Array(r),i=e.readUint32;break;case b.fieldTypes.SLONG:a=new Int32Array(r),i=e.readInt32;break;case b.fieldTypes.LONG8:case b.fieldTypes.IFD8:a=new Array(r),i=e.readUint64;break;case b.fieldTypes.SLONG8:a=new Array(r),i=e.readInt64;break;case b.fieldTypes.RATIONAL:a=new Uint32Array(2*r),i=e.readUint32;break;case b.fieldTypes.SRATIONAL:a=new Int32Array(2*r),i=e.readInt32;break;case b.fieldTypes.FLOAT:a=new Float32Array(r),i=e.readFloat32;break;case b.fieldTypes.DOUBLE:a=new Float64Array(r),i=e.readFloat64;break;default:throw new RangeError("Invalid field type: ".concat(t))}if(t!==b.fieldTypes.RATIONAL&&t!==b.fieldTypes.SRATIONAL)for(var u=0;u<r;++u)a[u]=i.call(e,n+u*s);else for(var f=0;f<r;f+=2)a[f]=i.call(e,n+f*s),a[f+1]=i.call(e,n+(f*s+4));return t===b.fieldTypes.ASCII?new TextDecoder("utf-8").decode(a):a}var R=function e(t,r,n){(0,c.default)(this,e),this.fileDirectory=t,this.geoKeyDirectory=r,this.nextIFDByteOffset=n},q=function(e){(0,i.default)(r,e);var t=O(r);function r(e){var n;return(0,c.default)(this,r),(n=t.call(this,"No image at index ".concat(e))).index=e,n}return r}((0,f.default)(Error)),P=function(){function t(){(0,c.default)(this,t)}return(0,a.default)(t,[{key:"readRasters",value:function(){var t=(0,n.default)(e.default.mark(function t(){var n,a,i,s,u,f,c,o,l,p,d,h,b,y,g,x,v,w,m,k,T,O,F,D,A,S,R,q,P,E,U,N,C,L,j,B,G,M,V,_=arguments;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=_.length>0&&void 0!==_[0]?_[0]:{},a=n.window,i=n.width,s=n.height,u=n.resX,f=n.resY,c=n.bbox,e.next=5,this.getImage();case 5:return o=e.sent,l=o,e.next=9,this.getImageCount();case 9:if(p=e.sent,d=o.getBoundingBox(),!a||!c){e.next=13;break}throw new Error('Both "bbox" and "window" passed.');case 13:if(!i&&!s){e.next=24;break}if(a&&(h=o.getOrigin(),b=(0,r.default)(h,2),y=b[0],g=b[1],x=o.getResolution(),v=(0,r.default)(x,2),w=v[0],m=v[1],c=[y+a[0]*w,g+a[1]*m,y+a[2]*w,g+a[3]*m]),k=c||d,!i){e.next=20;break}if(!u){e.next=19;break}throw new Error("Both width and resX passed");case 19:u=(k[2]-k[0])/i;case 20:if(!s){e.next=24;break}if(!f){e.next=23;break}throw new Error("Both width and resY passed");case 23:f=(k[3]-k[1])/s;case 24:if(!u&&!f){e.next=48;break}T=[],O=0;case 27:if(!(O<p)){e.next=36;break}return e.next=30,this.getImage(O);case 30:F=e.sent,D=F.fileDirectory,A=D.SubfileType,S=D.NewSubfileType,(0===O||2===A||1&S)&&T.push(F);case 33:++O,e.next=27;break;case 36:T.sort(function(e,t){return e.getWidth()-t.getWidth()}),R=0;case 38:if(!(R<T.length)){e.next=48;break}if(q=T[R],P=(d[2]-d[0])/q.getWidth(),E=(d[3]-d[1])/q.getHeight(),l=q,!(u&&u>P||f&&f>E)){e.next=45;break}return e.abrupt("break",48);case 45:++R,e.next=38;break;case 48:return U=a,c&&(N=o.getOrigin(),C=(0,r.default)(N,2),L=C[0],j=C[1],B=l.getResolution(o),G=(0,r.default)(B,2),M=G[0],V=G[1],U=[Math.round((c[0]-L)/M),Math.round((c[1]-j)/V),Math.round((c[2]-L)/M),Math.round((c[3]-j)/V)],U=[Math.min(U[0],U[2]),Math.min(U[1],U[3]),Math.max(U[0],U[2]),Math.max(U[1],U[3])]),e.abrupt("return",l.readRasters(I(I({},n),{},{window:U})));case 51:case"end":return e.stop()}},t,this)}));return function(){return t.apply(this,arguments)}}()}]),t}(),E=function(t){(0,i.default)(u,t);var s=O(u);function u(e,t,r,n){var a,i=arguments.length>4&&void 0!==arguments[4]?arguments[4]:{};return(0,c.default)(this,u),(a=s.call(this)).source=e,a.littleEndian=t,a.bigTiff=r,a.firstIFDOffset=n,a.cache=i.cache||!1,a.ifdRequests=[],a.ghostValues=null,a}return(0,a.default)(u,[{key:"getSlice",value:function(){var t=(0,n.default)(e.default.mark(function t(r,n){var a;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return a=this.bigTiff?4048:1024,e.t0=p.default,e.next=4,this.source.fetch(r,void 0!==n?n:a);case 4:return e.t1=e.sent,e.t2=r,e.t3=this.littleEndian,e.t4=this.bigTiff,e.abrupt("return",new e.t0(e.t1,e.t2,e.t3,e.t4));case 9:case"end":return e.stop()}},t,this)}));return function(e,r){return t.apply(this,arguments)}}()},{key:"parseFileDirectoryAt",value:function(){var t=(0,n.default)(e.default.mark(function t(r){var n,a,i,s,u,f,c,o,l,p,d,h,y,g,x,v,w,m,k,T;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=this.bigTiff?20:12,a=this.bigTiff?8:2,e.next=4,this.getSlice(r);case 4:if(i=e.sent,s=this.bigTiff?i.readUint64(r):i.readUint16(r),u=s*n+(this.bigTiff?16:6),i.covers(r,u)){e.next=11;break}return e.next=10,this.getSlice(r,u);case 10:i=e.sent;case 11:f={},c=r+(this.bigTiff?8:2),o=0;case 14:if(!(o<s)){e.next=41;break}if(l=i.readUint16(c),p=i.readUint16(c+2),d=this.bigTiff?i.readUint64(c+4):i.readUint32(c+4),h=void 0,y=void 0,g=D(p),x=c+(this.bigTiff?12:8),!(g*d<=(this.bigTiff?8:4))){e.next=26;break}h=S(i,p,d,x),e.next=36;break;case 26:if(v=i.readOffset(x),w=D(p)*d,!i.covers(v,w)){e.next=32;break}h=S(i,p,d,v),e.next=36;break;case 32:return e.next=34,this.getSlice(v,w);case 34:m=e.sent,h=S(m,p,d,v);case 36:y=1===d&&-1===b.arrayFields.indexOf(l)&&p!==b.fieldTypes.RATIONAL&&p!==b.fieldTypes.SRATIONAL?h[0]:h,f[b.fieldTagNames[l]]=y;case 38:c+=n,++o,e.next=14;break;case 41:return k=A(f),T=i.readOffset(r+a+n*s),e.abrupt("return",new R(f,k,T));case 44:case"end":return e.stop()}},t,this)}));return function(e){return t.apply(this,arguments)}}()},{key:"requestIFD",value:function(){var t=(0,n.default)(e.default.mark(function t(r){var a=this;return e.default.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:if(!this.ifdRequests[r]){t.next=4;break}return t.abrupt("return",this.ifdRequests[r]);case 4:if(0!==r){t.next=9;break}return this.ifdRequests[r]=this.parseFileDirectoryAt(this.firstIFDOffset),t.abrupt("return",this.ifdRequests[r]);case 9:if(this.ifdRequests[r-1]){t.next=19;break}t.prev=10,this.ifdRequests[r-1]=this.requestIFD(r-1),t.next=19;break;case 14:if(t.prev=14,t.t0=t.catch(10),!(t.t0 instanceof q)){t.next=18;break}throw new q(r);case 18:throw t.t0;case 19:return this.ifdRequests[r]=(0,n.default)(e.default.mark(function t(){var n;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,a.ifdRequests[r-1];case 2:if(0!==(n=e.sent).nextIFDByteOffset){e.next=5;break}throw new q(r);case 5:return e.abrupt("return",a.parseFileDirectoryAt(n.nextIFDByteOffset));case 6:case"end":return e.stop()}},t)}))(),t.abrupt("return",this.ifdRequests[r]);case 21:case"end":return t.stop()}},t,this,[[10,14]])}));return function(e){return t.apply(this,arguments)}}()},{key:"getImage",value:function(){var t=(0,n.default)(e.default.mark(function t(){var r,n,a=arguments;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return r=a.length>0&&void 0!==a[0]?a[0]:0,e.next=3,this.requestIFD(r);case 3:return n=e.sent,e.abrupt("return",new o.default(n.fileDirectory,n.geoKeyDirectory,this.dataView,this.littleEndian,this.cache,this.source));case 5:case"end":return e.stop()}},t,this)}));return function(){return t.apply(this,arguments)}}()},{key:"getImageCount",value:function(){var t=(0,n.default)(e.default.mark(function t(){var r,n;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:r=0,n=!0;case 2:if(!n){e.next=18;break}return e.prev=3,e.next=6,this.requestIFD(r);case 6:++r,e.next=16;break;case 9:if(e.prev=9,e.t0=e.catch(3),!(e.t0 instanceof q)){e.next=15;break}n=!1,e.next=16;break;case 15:throw e.t0;case 16:e.next=2;break;case 18:return e.abrupt("return",r);case 19:case"end":return e.stop()}},t,this,[[3,9]])}));return function(){return t.apply(this,arguments)}}()},{key:"getGhostValues",value:function(){var t=(0,n.default)(e.default.mark(function t(){var n,a,i,s,u,f,c,o,l=this;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(n=this.bigTiff?16:8,!this.ghostValues){e.next=3;break}return e.abrupt("return",this.ghostValues);case 3:return i=(a="GDAL_STRUCTURAL_METADATA_SIZE=").length+100,e.next=7,this.getSlice(n,i);case 7:if(s=e.sent,a!==S(s,b.fieldTypes.ASCII,a.length,n)){e.next=19;break}if(u=S(s,b.fieldTypes.ASCII,i,n),f=u.split("\n")[0],!((c=Number(f.split("=")[1].split(" ")[0])+f.length)>i)){e.next=16;break}return e.next=15,this.getSlice(n,c);case 15:s=e.sent;case 16:o=S(s,b.fieldTypes.ASCII,c,n),this.ghostValues={},o.split("\n").filter(function(e){return e.length>0}).map(function(e){return e.split("=")}).forEach(function(e){var t=(0,r.default)(e,2),n=t[0],a=t[1];l.ghostValues[n]=a});case 19:return e.abrupt("return",this.ghostValues);case 20:case"end":return e.stop()}},t,this)}));return function(){return t.apply(this,arguments)}}()},{key:"close",value:function(){return"function"==typeof this.source.close&&this.source.close()}}],[{key:"fromSource",value:function(){var t=(0,n.default)(e.default.mark(function t(r,n){var a,i,s,f,c,o,p;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,r.fetch(0,1024);case 2:if(a=e.sent,i=new l.default(a),18761!==(s=i.getUint16(0,0))){e.next=9;break}f=!0,e.next=14;break;case 9:if(19789!==s){e.next=13;break}f=!1,e.next=14;break;case 13:throw new TypeError("Invalid byte order value.");case 14:if(42!==(c=i.getUint16(2,f))){e.next=19;break}o=!1,e.next=27;break;case 19:if(43!==c){e.next=26;break}if(o=!0,8===i.getUint16(4,f)){e.next=24;break}throw new Error("Unsupported offset byte-size.");case 24:e.next=27;break;case 26:throw new TypeError("Invalid magic number.");case 27:return p=o?i.getUint64(8,f):i.getUint32(4,f),e.abrupt("return",new u(r,f,o,p,n));case 29:case"end":return e.stop()}},t)}));return function(e,r){return t.apply(this,arguments)}}()}]),u}(P);exports.GeoTIFF=E;var U=E;exports.default=U;var N=function(t){(0,i.default)(s,t);var r=O(s);function s(e,t){var n;return(0,c.default)(this,s),(n=r.call(this)).mainFile=e,n.overviewFiles=t,n.imageFiles=[e].concat(t),n.fileDirectoriesPerFile=null,n.fileDirectoriesPerFileParsing=null,n.imageCount=null,n}return(0,a.default)(s,[{key:"parseFileDirectoriesPerFile",value:function(){var t=(0,n.default)(e.default.mark(function t(){var r;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return r=[this.mainFile.parseFileDirectoryAt(this.mainFile.firstIFDOffset)].concat(this.overviewFiles.map(function(e){return e.parseFileDirectoryAt(e.firstIFDOffset)})),e.next=3,Promise.all(r);case 3:return this.fileDirectoriesPerFile=e.sent,e.abrupt("return",this.fileDirectoriesPerFile);case 5:case"end":return e.stop()}},t,this)}));return function(){return t.apply(this,arguments)}}()},{key:"getImage",value:function(){var t=(0,n.default)(e.default.mark(function t(){var r,n,a,i,s,u,f,c=arguments;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return r=c.length>0&&void 0!==c[0]?c[0]:0,e.next=3,this.getImageCount();case 3:return e.next=5,this.parseFileDirectoriesPerFile();case 5:n=0,a=0,i=0;case 8:if(!(i<this.imageFiles.length)){e.next=26;break}s=this.imageFiles[i],u=0;case 11:if(!(u<this.imageCounts[i])){e.next=22;break}if(r!==n){e.next=17;break}return e.next=15,s.requestIFD(a);case 15:return f=e.sent,e.abrupt("return",new o.default(f.fileDirectory,s.geoKeyDirectory,s.dataView,s.littleEndian,s.cache,s.source));case 17:n++,a++;case 19:u++,e.next=11;break;case 22:a=0;case 23:i++,e.next=8;break;case 26:throw new RangeError("Invalid image index");case 27:case"end":return e.stop()}},t,this)}));return function(){return t.apply(this,arguments)}}()},{key:"getImageCount",value:function(){var t=(0,n.default)(e.default.mark(function t(){var r;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(null===this.imageCount){e.next=2;break}return e.abrupt("return",this.imageCount);case 2:return r=[this.mainFile.getImageCount()].concat(this.overviewFiles.map(function(e){return e.getImageCount()})),e.next=5,Promise.all(r);case 5:return this.imageCounts=e.sent,this.imageCount=this.imageCounts.reduce(function(e,t){return e+t},0),e.abrupt("return",this.imageCount);case 8:case"end":return e.stop()}},t,this)}));return function(){return t.apply(this,arguments)}}()}]),s}(P);function C(e){return L.apply(this,arguments)}function L(){return(L=(0,n.default)(e.default.mark(function t(r){var n,a=arguments;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=a.length>1&&void 0!==a[1]?a[1]:{},e.abrupt("return",E.fromSource((0,h.makeRemoteSource)(r,n)));case 2:case"end":return e.stop()}},t)}))).apply(this,arguments)}function j(e){return B.apply(this,arguments)}function B(){return(B=(0,n.default)(e.default.mark(function t(r){return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",E.fromSource((0,h.makeBufferSource)(r)));case 1:case"end":return e.stop()}},t)}))).apply(this,arguments)}function G(e){return M.apply(this,arguments)}function M(){return(M=(0,n.default)(e.default.mark(function t(r){return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",E.fromSource((0,h.makeFileSource)(r)));case 1:case"end":return e.stop()}},t)}))).apply(this,arguments)}function V(e){return _.apply(this,arguments)}function _(){return(_=(0,n.default)(e.default.mark(function t(r){return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",E.fromSource((0,h.makeFileReaderSource)(r)));case 1:case"end":return e.stop()}},t)}))).apply(this,arguments)}function K(e){return Y.apply(this,arguments)}function Y(){return(Y=(0,n.default)(e.default.mark(function t(r){var n,a,i,s,u=arguments;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return n=u.length>1&&void 0!==u[1]?u[1]:[],a=u.length>2&&void 0!==u[2]?u[2]:{},e.next=4,E.fromSource((0,h.makeRemoteSource)(r,a));case 4:return i=e.sent,e.next=7,Promise.all(n.map(function(e){return E.fromSource((0,h.makeRemoteSource)(e,a))}));case 7:return s=e.sent,e.abrupt("return",new N(i,s));case 9:case"end":return e.stop()}},t)}))).apply(this,arguments)}function H(e,t){return W.apply(this,arguments)}function W(){return(W=(0,n.default)(e.default.mark(function t(r,n){return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.abrupt("return",(0,y.writeGeotiff)(r,n));case 1:case"end":return e.stop()}},t)}))).apply(this,arguments)}exports.MultiGeoTIFF=N;
},{"@babel/runtime/regenerator":"PMvg","@babel/runtime/helpers/defineProperty":"IxO8","@babel/runtime/helpers/slicedToArray":"HETk","@babel/runtime/helpers/asyncToGenerator":"agGE","@babel/runtime/helpers/createClass":"P8NW","@babel/runtime/helpers/inherits":"d4H2","@babel/runtime/helpers/possibleConstructorReturn":"pxk2","@babel/runtime/helpers/getPrototypeOf":"UJE0","@babel/runtime/helpers/wrapNativeSuper":"ozpi","@babel/runtime/helpers/classCallCheck":"fcMS","./geotiffimage":"eOWo","./dataview64":"dqpX","./dataslice":"dGLV","./pool":"dHPO","./source":"cUx7","./globals":"j27V","./geotiffwriter":"BGyE","./rgb":"fpBl","./compression":"FGCZ","./logging":"dy4f"}]},{},["bsJs"], "GeoTIFF")
